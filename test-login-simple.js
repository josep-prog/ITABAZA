...
async function testUnifiedLogin() {
  ...
  try {
    ...
    if (healthResponse.statusCode === 200) {
      ...
      console.log('⚠️  Server health check returned:', healthResponse.statusCode);
    }
  } catch (error) {
  ...
  console.log('   👨‍⚕️ Doctor: john.smith@medistar.com / doctor123');  
  console.log('   👨‍⚕️ Doctor: sarah.johnson@medistar.com / password123');
  console.log('   🛡️  Admin: [password needs to be determined]');
